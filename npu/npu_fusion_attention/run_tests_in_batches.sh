#!/bin/bash
source ~/.bashrc
cd /home/coder/fa-test-batch/
conda activate triton

# 配置参数
TOTAL_CASES=67  # 总测试案例数，根据实际情况调整
# TOTAL_CASES=2  # 总测试案例数，根据实际情况调整
BATCH_SIZE=1   # 每批运行的测试案例数量
SCRIPT_NAME="test_fa_fwd_npu_prof_tune_batch_asc.py"  # 您的测试脚本名称
