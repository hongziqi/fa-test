...
from test_fa_fwd_npu_prof_tune_batch_asc import test_results, RESULT_DIR  # 导入你的全局变量
...
def pytest_sessionfinish(session, exitstatus):
    ...
    if not test_results:
        ...
        return
    try:
        result_file = os.path.join(RESULT_DIR, "test_results_npu_tune_batch_asc_0913.xlsx")
